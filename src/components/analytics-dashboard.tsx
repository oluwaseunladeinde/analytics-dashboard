...
const Badge = ({ percentage }: { percentage: number }) => {
    ...
    const positiveClassname = 'bg-green-700/10 text-green-600 ring-green-400/25'
        ...
        <div className='flex flex-col gap-6'>
            <div className='grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6'>
                <Card className='w-full mx-auto max-w-xs'>
                    ...
                    <p className='text-3xl text-gray-900 text-dark font-semibold'>
                        {avgVisitorsPerDay}
                    </p>
                </Card>
                <Card className='w-full mx-auto max-w-xs'>
            ...
            <Card className='flex flex-col sm:grid grid-cols-4 gap-6'>
                <h2 className='w-full text-gray-700 text-center sm:left-left font-semibold text-xl'>
